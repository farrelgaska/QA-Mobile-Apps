...
class AppColors {
  static const Color primary = Color(0xFF006B5A);
  static const Color primaryDark = Color(0xFF005247);
  static const Color primarySoft = Color(0xFFE7F5F1);

  static const Color background = Color(0xFFF7F9F8);
  static const Color backgroundSoft = Color(0xFFF1F5F4);
  ...
  static const Color inactiveBg = Color(0xFFECEFEE);
  static const Color inactiveText = Color(0xFF6B7280);
}
